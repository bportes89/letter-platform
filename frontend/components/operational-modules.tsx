...
export function ProposalsModule() {
  ...
  return <OperationalLayout title="Propostas e simulações" subtitle="Cadastro comercial unificado para parceiros: Marketplace, SDC e Flash Capital. Simule, gere contrato e registre a venda." icon={<FileText/>}>
    <div className="notice"><Clock3/><div><b>Compliance automático por produto</b><small style={{display:"block",marginTop:"0.35rem",lineHeight:1.5}}><b>SDC</b> — após simular, a esteira interna valida LTV/lastro e aplica TAPAF R$ 1.500 na proposta vinculada (<Link href="/modules/sdc">SDC — estrutura interna</Link>).<br/><b>Flash Capital</b> — LTV 40% calculado automaticamente na simulação (valor do bem × 40%). Sem TAPAF nem RWA.<br/><b>Lease Equity / QuitCon</b> — TAPAF e tokenização RWA nos módulos próprios.</small></div></div>
