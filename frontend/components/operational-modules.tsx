...
export function InventoryModule() {
  ...
  return <OperationalLayout title="Inventário" subtitle="Admin cadastra cotas. Comercial: varredura Nina → trava 60 min → proposta → contrato (venda)." icon={<WalletCards/>}>
