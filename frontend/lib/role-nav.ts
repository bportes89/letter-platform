...
const ROLE_PLATFORM_MODULE_KEYS: Record<LetterRole, AccessList> = {
  ...
  MASTER_FRANCHISEE: ["crm", "mmn", "reports", "contracts", "wallet", "communications"],
  MANAGER: ["crm", "reports", "contracts", "communications"],
  PARTNER: ["crm", "contracts", "wallet", "mmn", "structured-properties", "communications"],
  CLIENT: ["contracts", "payments", "communications"],
  QUOTA_SELLER: ["crm", "contracts", "wallet", "communications"],
