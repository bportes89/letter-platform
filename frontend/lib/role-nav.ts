...
const ROLE_PRODUCT_KEYS: Record<LetterRole, AccessList> = {
  ...
  INTERNAL_STAFF: "*",
  MASTER_FRANCHISEE: [
    "marketplace", "venda-direta-robo", "venda-direta-manual", "cadastros", "fornecedores", "chat-faq", "inventory", "vender-cota", "proposals", "sdc",
    "flash-capital", "lease-equity", "flash-invest", "quitcon", "lss", "leilao",
  ],
  MANAGER: ["marketplace", "venda-direta-robo", "venda-direta-manual", "cadastros", "fornecedores", "chat-faq", "inventory", "vender-cota", "proposals", "sdc", "flash-capital", "lease-equity", "quitcon", "lss"],
  PARTNER: ["marketplace", "cadastros", "proposals", "sdc", "flash-capital", "lease-equity", "quitcon", "lss", "leilao"],
  CLIENT: ["minhas-compras", "proposals", "flash-capital", "lease-equity", "quitcon", "lss"],
  QUOTA_SELLER: ["marketplace", "cadastros", "proposals", "quitcon"],
