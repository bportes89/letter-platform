...
const ROLE_PRODUCT_KEYS: Record<LetterRole, AccessList> = {
  ...
  INTERNAL_STAFF: "*",
  MASTER_FRANCHISEE: [
    "marketplace", "venda-direta-robo", "venda-direta-manual", "fornecedores", "inventory", "vender-cota", "proposals", "sdc",
    "flash-capital", "lease-equity", "flash-invest", "quitcon", "lss", "leilao",
  ],
  MANAGER: ["marketplace", "venda-direta-robo", "venda-direta-manual", "fornecedores", "inventory", "vender-cota", "proposals", "sdc", "flash-capital", "lease-equity", "quitcon", "lss"],
