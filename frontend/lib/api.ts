...
export type Quota = { id: string; administrator_id: string; group_code: string; quota_code: string; category: string; credit_value: string; outstanding_balance: string; premium_value: string; installment_value?: string; installment_due_date?: string | null; remaining_installments?: number | null; supplier_source?: string | null; nina_scan_status?: string | null; nina_scanned_at?: string | null; status: string; created_at: string };
