...
export type NetworkReferral = { referral_code: string; tree_type: string; status: string; propagator_mode?: boolean; links: { cadastro: string; vender_cota: string; site: string } };
...
export type FundingOpportunity = {
  ...
  annual_return_reference: string | null;
  status: string;
  created_at: string;
};
export type InvestmentReservation = {
  id: string;
...
export type AdHocCharge = { id:string; charge_number:string; kind:string; description:string; due_date:string; total_amount:string; paid_amount:string; status:string; source:string; reference_type?:string|null; reference_id?:string|null; payment_checkout_url?:string|null; payable:boolean; created_at?:string|null };
...
export type Quota = { id: string; administrator_id: string; group_code: string; quota_code: string; category: string; credit_value: string; outstanding_balance: string; premium_value: string; entrada_final?: string | null; installment_value?: string; installment_due_date?: string | null; remaining_installments?: number | null; supplier_source?: string | null; nina_scan_status?: string | null; nina_scanned_at?: string | null; status: string; created_at: string; statement_document_id?: string | null; statement_filename?: string | null; compliance_rejection_reason?: string | null };
