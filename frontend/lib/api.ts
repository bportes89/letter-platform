...
export type FlashSimulation = {asset_value:string;principal:string;ltv_percent:string;coverage_factor:string;ipca_projected_percent:string;execution:string;scenarios:Record<string,FlashScheduleRow[]>};
