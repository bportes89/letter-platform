...
def seed():
    ...
    with SessionLocal() as db:
        ...
        db.add_all([
            Quota(organization_id=org.id, administrator_id=adm.id, seller_id=admin.id, group_code="1001", quota_code="001", category="REAL_ESTATE", credit_value=Decimal("400000"), outstanding_balance=Decimal("250000"), premium_value=Decimal("80000"), installment_value=Decimal("2800"), installment_due_date=date(2026, 9, 10)),
            Quota(organization_id=org.id, administrator_id=adm.id, seller_id=admin.id, group_code="1001", quota_code="002", category="REAL_ESTATE", credit_value=Decimal("400000"), outstanding_balance=Decimal("250000"), premium_value=Decimal("78000"), installment_value=Decimal("2750"), installment_due_date=date(2026, 9, 15)),
        ])
