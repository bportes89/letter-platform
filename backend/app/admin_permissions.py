...
PERMISSION_GROUPS: list[PermissionGroupDef] = [
    ...
    },
    {
        ...
        "items": [
            ...
            {"key": "marketplace.venda_direta", "label": "Venda Direta", "modules": ["venda-direta-manual"], "scopes": ["leads:write"]},
            {"key": "marketplace.venda_direta_robo", "label": "Venda Direta (Robô)", "modules": ["venda-direta-robo"], "scopes": ["leads:write"]},
